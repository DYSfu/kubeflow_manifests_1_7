...
images:
  - name: gcr.lank8s.cn/kubeflow-images-public/profile-controller
    newName: gcr.lank8s.cn/kubeflow-images-public/profile-controller
...
spec:
  ...
  template:
    ...
    spec:
      ...
      - command:
        - /manager
        image: gcr.lank8s.cn/kubeflow-images-public/profile-controller:v20190228-v0.4.0-rc.1-192-g1a802656-dirty-f95773
